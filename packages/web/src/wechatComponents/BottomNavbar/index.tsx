		...
		>
			...
			>
				<Badge
					...
					className={WECHAT.badgeType === "dot" ? "top-0 right-0" : "-right-3"}
			...
			>
				<Badge
					...
					className={DISCOVER.badgeType === "dot" ? "top-0 right-0" : "-right-3"}
			...
			>
				<Badge
					text={MY.badgeNumber}
					type={MY.badgeType}
					className={MY.badgeType === "dot" ? "top-0 right-0" : "-right-3"}
					hidden={MY.badgeHide}
				>
					{MY.activated ? (
